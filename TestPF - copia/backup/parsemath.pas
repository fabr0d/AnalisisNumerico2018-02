...
begin
   with FParser.Identifiers do begin
       ...
       AddFunction('root1', 'S', 'SFFB', @ExprRoot1);
       AddFunction('root2', 'S', 'SFFBI', @ExprRoot2);
       AddFunction('polyroot', 'S', 'S', @ExprPolyroot);
       AddFunction('polynomial', 'S', 'SS', @ExprPolynomial);
       AddFunction('eval', 'F', 'S', @ExprEval);
       AddFunction('senl', 'F', 'SSS', @ExprSenl);
       AddFunction('plot2d', '', 'SFFS', @ExprPlot2d);
       AddFunction('intersection', '', 'SFFS', @ExprIntersection);
